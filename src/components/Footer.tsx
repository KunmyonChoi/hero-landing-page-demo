...
export default function Footer() {
  return (
    <footer id="about" className="border-t border-white/10 pt-16 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-6 max-w-xs">
              Transform your media with cutting-edge AI technology. Enhance videos,
              separate audio, and generate subtitles with ease.
            </p>
            {/* Social links */}
